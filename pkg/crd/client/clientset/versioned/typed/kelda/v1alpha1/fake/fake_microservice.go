...
var microservicesResource = schema.GroupVersionResource{Group: "kelda.io", Version: "v1alpha1", Resource: "microservices"}

var microservicesKind = schema.GroupVersionKind{Group: "kelda.io", Version: "v1alpha1", Kind: "Microservice"}
...
func (c *FakeMicroservices) List(opts v1.ListOptions) (result *v1alpha1.MicroserviceList, err error) {
	...
	list := &v1alpha1.MicroserviceList{ListMeta: obj.(*v1alpha1.MicroserviceList).ListMeta}
...
func (c *FakeMicroservices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Microservice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(microservicesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Microservice{})
