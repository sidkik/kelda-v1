...
// source: _proto/kelda/errors/v0/errors.proto
...
type Error struct {
	...
	// it's assumed that the error isn't a special Kelda type, and can be created
	// with errors.New.
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc7d47bab900ecfe, []int{0}
}
...
func (*ContextError) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc7d47bab900ecfe, []int{1}
}
...
func (*FriendlyError) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc7d47bab900ecfe, []int{2}
}
...
func init() {
	proto.RegisterType((*Error)(nil), "kelda.errors.v0.Error")
	proto.RegisterType((*ContextError)(nil), "kelda.errors.v0.ContextError")
	proto.RegisterType((*FriendlyError)(nil), "kelda.errors.v0.FriendlyError")
}

func init() {
	proto.RegisterFile("_proto/kelda/errors/v0/errors.proto", fileDescriptor_dc7d47bab900ecfe)
}

var fileDescriptor_dc7d47bab900ecfe = []byte{
	// 247 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x8e, 0x2f, 0x28, 0xca,
	0x2f, 0xc9, 0xd7, 0xcf, 0x4e, 0xcd, 0x49, 0x49, 0xd4, 0x4f, 0x2d, 0x2a, 0xca, 0x2f, 0x2a, 0xd6,
	...
	0x2f, 0x39, 0x3f, 0x17, 0x12, 0xf0, 0xba, 0x99, 0x79, 0xc9, 0xd0, 0x28, 0x28, 0xc8, 0x4e, 0xd7,
	0x87, 0x44, 0x09, 0xc4, 0x51, 0x49, 0x6c, 0x60, 0x9e, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xfd,
	0xdf, 0xc2, 0xcd, 0xaa, 0x01, 0x00, 0x00,
}
